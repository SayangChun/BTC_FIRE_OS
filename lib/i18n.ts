export const translations = {
  zhCN: {
    ...
    ahr999: {
      ...
      updated: "更新时间",
      methodology: "公式参考非小号：价格 / 200日定投成本 × 价格 / 指数增长估值；0.45-1.2 为理论定投区间。",
    },
    fire: {
      title: "FIRE 计算器",
  ...
  zhTW: {
    ...
    ahr999: {
      ...
      updated: "更新時間",
      methodology: "公式參考非小號：價格 / 200日定投成本 × 價格 / 指數增長估值；0.45-1.2 為理論定投區間。",
    },
    fire: {
      title: "FIRE 計算器",
      monthlyExpenses: "每月支出",
  ...
  en: {
    ...
    ahr999: {
      ...
      updated: "Updated",
      methodology:
        "Formula follows Feixiaohao: price / 200-day DCA cost × price / exponential growth valuation; 0.45-1.2 is the theoretical DCA zone.",
    },
    fire: {
